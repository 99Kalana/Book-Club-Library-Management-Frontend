...
interface OverdueReadersTableProps {
...
const OverdueReadersTable: React.FC<OverdueReadersTableProps> = ({
                                                                     overdueTransactions,
                                                                     currentPage,
                                                                     totalPages,
                                                                     onPageChange,
    ...
    const headers: { key: string; label: string; sortable: boolean; icon?: React.ReactNode }[] = [
        { key: 'readerName', label: 'Reader Name', sortable: true, icon: <MdPerson className="w-4 h-4" /> },
        { key: 'readerEmail', label: 'Reader Email', sortable: true, icon: <MdEmail className="w-4 h-4" /> },
        { key: 'bookTitle', label: 'Overdue Book', sortable: true, icon: <MdBook className="w-4 h-4" /> },
